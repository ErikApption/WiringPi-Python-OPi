...
SWIGINTERN PyObject *_wrap_wiringPiSPISetupMode(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "wiringPiSPISetupMode", 4, 4, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "wiringPiSPISetupMode" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)wiringPiSPISetupMode(arg1,arg2,arg3,arg4);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "piBoardId", _wrap_piBoardId, METH_O, NULL},
